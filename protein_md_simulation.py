...
def on_file_list_change(working_directory_path,
    ...
    if protein_structure_file_name in structure_files:
        topology_input_file_name = protein_structure_file_name
    else:
        topology_input_file_name = structure_files[0] if structure_files else None

    # Update box input file name dropdown
    if topology_output_file_name in structure_files:
        box_input_file_name = topology_output_file_name
    else:
    ...
    if topology_output_topology_file_name in topology_files:
        solvation_input_topology_file_name = topology_output_topology_file_name
    else:
    ...
    return file_df, \
        gr.update(choices=structure_files, value=topology_input_file_name), \
