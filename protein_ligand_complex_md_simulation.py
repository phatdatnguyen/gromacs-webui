...
def on_generate_nvt_equilibration_mdp_file(working_directory_path: str, time_scale: float, time_step: float,
    ...
    try:
        ...
        file_content = get_default_nvt_equilibration_mdp_file_content(
            ...
            temperature=temperature, with_ligand=True,
            force_field=force_field, random_seed=random_seed)
        file_path = os.path.join(working_directory_path, parameter_file_name)
        with reserve_working_directory_maintenance(working_directory_path):
            atomic_write_text_file(file_path, file_content)
...
def protein_ligand_complex_md_simulation_tab_content() -> None:
    ...
    nvt_equilibration_parameter_file_button.click(on_generate_nvt_equilibration_mdp_file, [working_directory_path_state, nvt_time_scale_slider, nvt_time_step_slider, nvt_temperature_slider, nvt_equilibration_parameter_file_name_textbox, protein_force_field_dropdown, nvt_random_seed_slider], [working_directory_file_list_state, status_markdown])
